              ...
              <div className="ml-0 md:ml-[1vw] mt-8 md:mt-[5vw] text-white max-w-full md:max-w-[40%] p-4 md:p-10">
                ...
                <div className="space-y-4 mt-4 md:mt-8">
                  <p>
                    ...
                    Hérouville-Saint-Clair, dans le département du Calvados.
                    Fondé en 2010, le club est initialement créé comme section
                    futsal du Sporting Club hérouvillais, un club de football
                    régional.
                  </p>
                  <p>
